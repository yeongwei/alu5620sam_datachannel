...
for( var i in lte_S11Peer_Name)
{
	MasterPropertyMap[lte_S11Peer_Name[i]] = i;
	ReverseMasterPropertyMap[lte_S11Peer_Name[i]] = i;
	reverse_lte_S11Peer_Name[lte_S11Peer_Name[i]] = i;
}

function lte_S11Peer(samObject, modelInterface, className)
{
	logP4Msg("lte_S11Peer", "SAMIF", "entered lte_S11Peer" );
    ...
    subelement.family = "5620_SAM_S11Peer";
    ...
    subelement.addProperty("samFamilyName", "5620_SAM_S11Peer");

    for( var i in lte_S11Peer_Name) 
    {
    	if ( samObject[ lte_S11Peer_Name[i] ] != undefined )
        {
                subelement.addProperty( i.toString(), samObject[ lte_S11Peer_Name[i] ].toString() );
                logP4Msg("lte_S11Peer", "addProperty", "property: " + i.toString() +" value: "+ samObject[ lte_S11Peer_Name[i] ].toString() );
	    }
    }
...
function jms_delete_lte_S11Peer(record)
{
     turn_off_SE(record);
}
