...
var reverse_nat_IsaMember_Name = {},
nat_IsaMember_Name =
{
	...
	"samSiteId"              : "siteId",
	"samMemberId"			 : "memberId"
};

for( var i in nat_IsaMember_Name)
{
	MasterPropertyMap[nat_IsaMember_Name[i]] = i;
	ReverseMasterPropertyMap[nat_IsaMember_Name[i]] = i;
	reverse_nat_IsaMember_Name[nat_IsaMember_Name[i]] = i;
}

function nat_IsaMember(samObject, modelInterface, className)
{
	
	logP3Msg("nat_IsaMember", "SAMIF"  , "entered nat_IsaMember");
    var element;
    var subelement;
    ...
    subelement.family = "5620_SAM_Member";
...
//    subelement.instance = samObject.objectFullName;
    ...
    subelement.addProperty("samFamilyName", "5620_SAM_Member");
    ...
    for( var i in nat_IsaMember_Name) 
    {
		...
		}else if ( samObject[ nat_IsaMember_Name[i] ] != undefined ){
             subelement.addProperty( i.toString(), samObject[ nat_IsaMember_Name[i] ].toString() );
	    }
    }
...
function jms_delete_nat_IsaMember(record)
{
    //var myId;
...
function jms_speed_update_nat_IsaMember(objectName, propColl)
{
    ...
    logP4Msg("jms_speed_update_nat_IsaMember", "SAMIF", "object: "+objectName);	
    ...
    for( i in propColl)
    {
        ...
        if (propName == "speed")
        {
            ...
            logP4Msg("jms_speed_update_nat_IsaMember", "SAMIF", "samSpeed old value " + propOldValue);
            logP4Msg("jms_speed_update_nat_IsaMember", "SAMIF", "samSpeed new value " + propValue);
        }
    }
}
